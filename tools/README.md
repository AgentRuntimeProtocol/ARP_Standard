...
- Python SDK codegen (requires deps): `python tools/codegen/python/generate.py --version v1alpha1`
- Python SDK build (requires deps): `python tools/codegen/python/build_local.py --version v1alpha1 --clean`
